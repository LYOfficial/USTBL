...
pub async fn run() -> i32 {
  tauri::Builder::default()
    ...
    .invoke_handler(tauri::generate_handler![
      ...
      account::commands::refresh_vustb_account,
      account::commands::sync_vustb_account,
      account::commands::create_vustb_profile,
      ...
      instance::shared::retrieve_shared_instance_binding,
      instance::shared::set_shared_instance_binding,
      instance::shared::ignore_shared_instance_binding_prompt,
