...
pub static SCOPE: &str =
  "openid offline_access userinfo permission Yggdrasil.PlayerProfiles.Select Yggdrasil.Server.Join launcher.api launcher.skins.read launcher.skins.write launcher.profiles.create";
